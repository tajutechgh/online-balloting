...
class PageVersionConnection_ed06adc06000e0f52bb09fc06dd7dea5 extends ObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'PageVersionConnection',
                'fields' => function () {
                $fields = [];
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::PageVersionConnectionEdge()))),
...
;
                    $fields[] = [
                        'name' => 'nodes',
                        'type' => Types::listOf(Types::PageVersion()),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
