...
// @type:QueryFilterStringComparator
class QueryFilterStringComparator_1072596cbb5292651be6b214a1aeabd1 extends InputObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'QueryFilterStringComparator',
                'fields' => function () {
                $fields = [];
