...
// @type:QueryFilterSortDirectionComparator
class QueryFilterSortDirectionComparator_bce22b91f1f6e519197b9a6ddbd4b586 extends InputObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'QueryFilterSortDirectionComparator',
                'fields' => function () {
                $fields = [];
...
;
                    $fields[] = [
                        'name' => 'in',
                        'type' => Types::listOf(Types::SortDirection()),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
