...
// @type:QueryFilterVersionedStatusComparator
class QueryFilterVersionedStatusComparator_3237cd08e3c1eb1e885ae4525ccdef21 extends InputObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'QueryFilterVersionedStatusComparator',
                'fields' => function () {
                $fields = [];
