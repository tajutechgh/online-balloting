...
// @type:QueryFilterVersionedStageComparator
class QueryFilterVersionedStageComparator_a6a98dc1521b11b7a9d73d1f3b9b3e13 extends InputObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'QueryFilterVersionedStageComparator',
                'fields' => function () {
                $fields = [];
...
;
                    $fields[] = [
                        'name' => 'in',
                        'type' => Types::listOf(Types::VersionedStage()),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
