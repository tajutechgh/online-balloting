...
// @type:FileInterfaceConnection
class FileInterfaceConnection_5fed1760bffff2cfab930ec3eb57bae7 extends ObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'FileInterfaceConnection',
                'fields' => function () {
                $fields = [];
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::FileInterfaceConnectionEdge()))),
