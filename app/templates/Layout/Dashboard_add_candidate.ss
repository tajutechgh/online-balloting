                        ...
                        <form action="/dashboard/submit-candidate" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" name="Name" required style="margin-bottom: 20px;">
                                    ...
                                    <input type="file" class="form-control" name="Photo" required style="margin-bottom: 20px;">
                                </div>
                                <div class="col-md-4">
                                    <br>
