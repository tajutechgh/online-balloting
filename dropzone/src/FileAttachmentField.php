...
class FileAttachmentField extends FileField
{
    ...
    public function upload(HTTPRequest $request)
    {
        ...
        $this->addValidFileIDs($ids);
        $output = new HTTPResponse(implode(',', $ids), 200);
    ...
    {
        return $this->getSetting('thumbnailsDir') ?: ModuleResourceLoader::singleton()->resolveResource('unclecheese/dropzone:images/file-icons');
    }
